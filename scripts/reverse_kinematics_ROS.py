...
class Reverse_Kinematics_ROS:
    ...
    def callback(self, msg: Point32):
        ...
        if self.use_up:
            ...
            self.theta = [-theta_3_up, theta_2_up, -1*(right_angle - theta_1_up), theta_0]
        else:
    ...
    def reverse_kinematics_ROS(self):
        rospy.init_node("reverse_kinematics", anonymous=True)
        self.pub = rospy.Publisher("desired_joint_states", JointState, queue_size=20)
        rospy.Subscriber("zone_location", Point32, self.callback)
